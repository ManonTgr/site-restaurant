      ...
      @endforeach
            ...
            <form action="{{ route('admin.reservation.update', ['id' => $reservation->id]) }}" method="post">
                ...
                <div>
                    ...
                    <input type="text" name="nom" id="" min="3" max="100"
                        value ="{{ old('nom', $reservation->nom) }}" not-required style="color: black;">
                    @error('nom')
                ...
                <div>
                    ...
                    <input type="number" name="couverts" id="couverts" min="1"
                        max="16"value="{{ old('couverts', $reservation->couvert) }}" not-required
                        style="color: black;">
                    @error('couverts')
                ...
                <div>
                    ...
                    <select name="heure" id="heure" not-required style="color: black;">
                        ...
                        @foreach ($heures as $heure)
                            <option value="{{ $heure }}" {{ old('heure') == $heure . ':00' ? 'selected' : '' }}>
                                {{ $heure }} </option>

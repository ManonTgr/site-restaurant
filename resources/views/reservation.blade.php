  ...
  <div class="reservation-section">
    ...
    <form action="{{ route('main.reservation.store')}}" method="post"> 
      ...
      <div>
        ...
        <input type="text" name="nom" id="nom" min="3" max="100" value ="{{ old('nom')}}" not-required style="color: black;">
        @error('nom')
      ...
      <div>
        ...
        <input type="tel" name="telephone" id="telephone" value ="{{ old('telephone')}}" placeholder="Format: 0600000000" style="color: black;">             
        @error('telephone')
        <div class="invalid-feedback">{{ $message}}</div><!-- texte sur une seule ligne-->
        @enderror
      </div>
